...
public:
    ...
    void Draw(float time, const glm::mat4 &model = IDENTITY_MATRIX,
              ...
              const glm::mat4 &projection = IDENTITY_MATRIX, bool noise_debug = false, bool draw_sand = true) {
        glUseProgram(program_id_);
        glBindVertexArray(vertex_array_id_);

        glUniform1i(glGetUniformLocation(program_id_, "noise_debug"), noise_debug ? 1 : 0);
